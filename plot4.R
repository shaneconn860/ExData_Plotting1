...
par(mfrow=c(2,2))
plot(data2$newtime, data2$Global_active_power, type="l", col="green", xlab="", ylab="Global Active Power")
plot(data2$newtime, data2$Voltage, type="l", col="orange", xlab="datetime", ylab="Voltage")
...
plot(data2$newtime, data2$Global_reactive_power, type="l", col="blue", xlab="datetime", ylab="Global_reactive_power")
